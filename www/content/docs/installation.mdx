...
The recommended way to run Valka is with the provided Docker Compose file:
...
Mount a `valka.toml` into the container at the working directory for file-based configuration:
