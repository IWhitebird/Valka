...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in valka/v1/worker_pb2_grpc.py depends on'
...
def add_WorkerServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'valka.v1.WorkerService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('valka.v1.WorkerService', rpc_method_handlers)
